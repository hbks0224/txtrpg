    ...
    internal class Intro
    {
        ...
        public static void name()
        {
            ...
            while (true)
            {
                ...
                {
                    Dialogue.Print("아니라고? 그럼 진짜 너의 이름은 뭐야?");
                ...
                else
                {
                    ...
                    Dialogue.Print("너는 대답도 제대로 할 줄 모르나 보군? (Y 또는 N만 입력하세요.)");
                }
